...
class TypesGravesTableSeeder extends Seeder {
	...
	public function run()
	{
		DB::table('buried')->delete();
		DB::table('dispatchers')->delete();
		DB::table('graves')->delete();
		...
		DB::unprepared("ALTER TABLE graves AUTO_INCREMENT = 1;");
		DB::unprepared("ALTER TABLE dispatchers AUTO_INCREMENT = 1;");
		DB::unprepared("ALTER TABLE buried AUTO_INCREMENT = 1;");
